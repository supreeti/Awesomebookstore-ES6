...
var luxon = (function (exports) {
    ...
    function stringifyTokens(splits, tokenToString) {
        ...
        for (
            var _iterator = _createForOfIteratorHelperLoose(splits), _step; !(_step = _iterator()).done;
    ...
    function combineRegexes() {
        for (
            var _len = arguments.length, regexes = new Array(_len), _key = 0; _key < _len; _key++
        ) {
    ...
    function combineExtractors() {
        for (
            var _len2 = arguments.length, extractors = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++
        ) {
    ...
    function simpleParse() {
        for (
            var _len4 = arguments.length, keys = new Array(_len4), _key4 = 0; _key4 < _len4; _key4++
        ) {
    ...
    var Duration = /*#__PURE__*/ (function () {
        ...
        _proto.plus = function plus(duration) {
            ...
            for (
                var _iterator = _createForOfIteratorHelperLoose(orderedUnits$1), _step; !(_step = _iterator()).done;
        ...
        _proto.mapUnits = function mapUnits(fn) {
            ...
            for (
                var _i = 0, _Object$keys = Object.keys(this.values); _i < _Object$keys.length; _i++
            ) {
        ...
        _proto.shiftTo = function shiftTo() {
            for (
                var _len = arguments.length, units = new Array(_len), _key = 0; _key < _len; _key++
            ) {
        ...
        _proto.negate = function negate() {
            ...
            for (
                var _i2 = 0, _Object$keys2 = Object.keys(this.values); _i2 < _Object$keys2.length; _i2++
            ) {
    ...
    var Interval = /*#__PURE__*/ (function () {
        ...
        _proto.splitAt = function splitAt() {
            ...
            for (
                var _len = arguments.length, dateTimes = new Array(_len), _key = 0; _key < _len; _key++
            ) {
        ...
        Interval.xor = function xor(intervals) {
            ...
            for (
                var _iterator = _createForOfIteratorHelperLoose(arr), _step; !(_step = _iterator()).done;
        ...
        _proto.difference = function difference() {
            ...
            for (
                var _len2 = arguments.length, intervals = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++
            ) {
    ...
    function quickDT(obj, opts) {
        ...
        if (!isUndefined(obj.year)) {
            for (
                var _iterator = _createForOfIteratorHelperLoose(orderedUnits), _step; !(_step = _iterator()).done;
    ...
    function diffRelative(start, end, opts) {
        ...
        for (
            var _iterator2 = _createForOfIteratorHelperLoose(opts.units), _step2; !(_step2 = _iterator2()).done;
    ...
    var DateTime = /*#__PURE__*/ (function () {
        ...
        DateTime.fromObject = function fromObject(obj, opts) {
            ...
            for (
                var _iterator3 = _createForOfIteratorHelperLoose(units), _step3; !(_step3 = _iterator3()).done;
        ...
        DateTime.max = function max() {
            for (
                var _len2 = arguments.length, dateTimes = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++
            ) {
